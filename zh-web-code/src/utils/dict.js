...
export const DICT_TYPE = {
  ...
  GRANFA_URL: 'grafana_url',
  WIKI_URL: 'wiki_url',
  ALARM_URL: 'alarm_url',
  SCREEN_URL: 'screen_url',
  DATAEASE_URL: 'dataEase_url',
  REPORT_URL: 'report_url',
  USER_TYPE: 'user_type',
  COMMON_STATUS: 'common_status',
  ASSETMONITORTYPE:'assetMonitorType',
  TERMINAL: 'terminal',
  ...
  ASSET_DEPLOY_ENV: 'asset_deploy_env',
  ASSET_DEPLOY_REGION: 'asset_deploy_region',
  //  ========= X平台 ================
  ...
  BPM_PROCESS_INSTANCE_COMMON_CELLS: 'bpm_process_instance_common_cells',
  ...
  SCHEDULE_SHIFT_TIME_RANGE: 'schedule_shift_time_range',
  // ========== 模型 模块 ==========
