	...
	<el-form size='small'>
		...
		<el-form-item>
			<el-radio v-model='radioValue' :label="6">
				指定
				<el-select v-model="checkboxList" placeholder="可多选" multiple style="width:100%">
					<el-option v-for="(item, index) of weekList" :key="index" :label="item.value"
