        ...
        setTimeout(() => {
          ...
          reqCheck(data).then(res => {
            if (res.repCode === '0000') {
                ...
                this.text = this.$t('common.verifyPoints.success')
                ...
                this.text = this.$t('common.verifyPoints.failure')
                setTimeout(() => {
                  this.refresh()
                }, 700)
              }
    ...
    getPictrue() {
      ...
      reqGet(data).then(res => {
        if (res.repCode === '0000') {
          ...
          this.text = this.$t('common.verifyPoints.prompt', { words: this.poinTextList.join(',') })
        } else {
