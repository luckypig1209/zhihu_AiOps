<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="账号数量上限" align="center" prop="accountCount">
        <template v-slot="scope">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="110px">
        ...
        <el-form-item label="账号数量上限" prop="accountCount">
          <el-input-number v-model="form.accountCount" placeholder="请输入账号数量上限" controls-position="right" :min="0" />
        </el-form-item>
        <el-form-item label="过期时间" prop="expireTime">
          <el-date-picker clearable size="small" v-model="form.expireTime" type="datetime"
