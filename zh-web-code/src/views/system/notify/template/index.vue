  ...
  <div class="app-container">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="150">
        <template v-slot="scope">
          <el-button size="mini" type="text" icon="el-icon-share" @click="handleSendNotify(scope.row)"
                     v-hasPermi="['system:notify-template:send-notify']">推送</el-button>
    ...
    <el-dialog title="发送站内信" :visible.sync="sendNotifyOpen" width="500px" append-to-body>
      <el-form ref="sendNotifyForm" :model="sendNotifyForm" :rules="sendNotifyRules" label-width="140px">
        ...
        <el-form-item label="发送所有人" prop="isAll">
          <el-radio-group v-model="sendNotifyForm.isAll">
            <el-radio :label="1">是</el-radio>
            <el-radio :label="0">否</el-radio>
          </el-radio-group>
        </el-form-item>
        <el-form-item v-if="sendNotifyForm.isAll === 0" label="接收人" prop="userIds">
          <el-select v-model="sendNotifyForm.userIds" multiple placeholder="请输入接收人" clearable style="width: 100%">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submitSendNotifyForm" :loading="sendLoading">确 定</el-button>
...
export default {
  ...
  data() {
    return {
      ...
      sendNotifyRules: {
        userIds: [{ required: true, message: "接收人不能为空", trigger: "blur" }],
        isAll: [{ required: true, message: "是否发送所有人不能为空", trigger: ["blur", "change"] }],
