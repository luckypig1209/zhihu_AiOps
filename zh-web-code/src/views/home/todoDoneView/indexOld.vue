...
<template>
  <Card style="border-radius: 24px;">
    ...
    <div class="row">
      <div class="title-box my">
        <div>我的发起</div>
        <div>{{myData.sum || '0'}}</div>
      </div>
      <div class="pending my">
        <div class="sub-title">
          <img src="../../../assets/images/home/people.png" alt="">
          <div>处理中</div>
        </div>
        <div @click="toPath('/task/my', { status: '1' })">{{myData.pending || '0'}}</div>
      </div>
      <div class="resolve my">
        <div class="sub-title">
          <img src="../../../assets/images/home/box.png" alt="">
          <div>已完结</div>
        </div>
        <div @click="toPath('/task/my', { status: '2' })">{{myData.resolve || '0'}}</div>
      </div>
    </div>
    <div class="row">
