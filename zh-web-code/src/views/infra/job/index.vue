<template>
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="100px">
      ...
      <el-form-item label="操作器的名字" prop="handlerName">
        <el-input v-model="queryParams.handlerName" placeholder="请输入操作器的名字" clearable @keyup.enter.native="handleQuery"/>
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="jobList">
      ...
      <el-table-column label="操作器的名字" align="center" prop="handlerName" />
      <el-table-column label="操作器的参数" align="center" prop="handlerParam" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        ...
        <el-form-item label="操作器的名字" prop="handlerName">
          <el-input v-model="form.handlerName" placeholder="请输入操作器的名字" v-bind:readonly="form.id !== undefined" />
        </el-form-item>
        <el-form-item label="操作器的参数" prop="handlerParam">
          <el-input v-model="form.handlerParam" placeholder="请输入操作器的参数" />
        </el-form-item>
      ...
      <el-form ref="form" :model="form" label-width="200px" size="mini">
        <el-row>
          <el-col :span="24">
            ...
            <el-form-item label="操作器的名字：">{{ form.handlerName }}</el-form-item>
            <el-form-item label="操作器的参数：">{{ form.handlerParam }}</el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        handlerName: [{ required: true, message: "操作器的名字不能为空", trigger: "blur" }],
