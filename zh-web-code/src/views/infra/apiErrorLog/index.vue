<template>
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="操作状态" prop="processStatus">
        <el-select v-model="queryParams.processStatus" placeholder="请选择操作状态" clearable>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="small" @click="handleExport" :loading="exportLoading"
                   v-hasPermi="['system:api-error-log:export']">导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="操作状态" align="center" prop="processStatus">
        <template v-slot="scope">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template v-slot="scope">
          <el-button size="mini" type="text" icon="el-icon-view" @click="handleView(scope.row,scope.index)"
                     v-hasPermi="['system:api-access-log:query']">详细</el-button>
          <el-button type="text" size="mini" icon="el-icon-check"
              v-if="scope.row.processStatus === InfApiErrorLogProcessStatusEnum.INIT" v-hasPermi="['system:api-error-log:update-status']"
              @click="handleProcessClick(scope.row, InfApiErrorLogProcessStatusEnum.DONE)">已操作</el-button>
          <el-button type="text" size="mini" icon="el-icon-check"
                     v-if="scope.row.processStatus === InfApiErrorLogProcessStatusEnum.INIT" v-hasPermi="['system:api-error-log:update-status']"
      ...
      <el-form ref="form" :model="form" label-width="100px" size="mini">
        <el-row>
          <el-col :span="24">
            ...
            <el-form-item label="操作人">{{ form.processUserId }}</el-form-item>
            <el-form-item label="操作时间">{{ parseTime(form.processTime) }}</el-form-item>
          </el-col>
        </el-row>
      </el-form>
